...
public class ArraysUtility {
    ...
    //prints each double of array in a separate lines
    ...
    //prints each char of array in a separate lines
    ...
    //prints each string of array in a separate lines
    ...
    //returns the min number for array
    ...
    //checks if the given String i/s contained in the given array, returns boolean, contains(String[], String)
    ...
    // adds the given integer to array
   public static int[] addElement(int[] array, int element){
    ...
    // adds the given double to array
    ...
    // adds the given String to array
    ...
    //replaces the given element with a new one
    ...
    //replaces all the matching old value with a new one
