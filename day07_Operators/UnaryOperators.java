...
public class UnaryOperators {
    public static void main(String[] args) {
        ...
        System.out.println(--x); // pre decrement: it decreases the value right away
        System.out.println(x);

        int y = 200;
        System.out.println(y--); //post decrement: irst passes the current value, then increases the value by 1
        ...
        System.out.println(z++); // post increment = 45, z=47
